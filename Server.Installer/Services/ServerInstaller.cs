        ...
        public async Task PerformInstall(CliParams cliParams)
        {
            ...
            if (cliParams.UsePrebuiltPackage == true)
            {
                ...
                var releaseFile = cliParams.WebServer == WebServerType.IisWindows ?
                    "https://github.com/aruntomy98/Remotely/releases/latest/download/Remotely_Server_Win-x64.zip" :
                    "https://github.com/aruntomy98/Remotely/releases/latest/download/Remotely_Server_Linux-x64.zip";
