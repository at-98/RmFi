...
namespace Server.Installer
{
    ...
    public class Program
    {
        ...
        private static void ShowHelpText()
        {
            ...
            ConsoleHelper.WriteLine("sudo ./RmFi_Server_Installer -b false -u aruntomy98 -p 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 -s https://app.remotely.one -i /var/www/remotely/ -r latest -c true -w 0", 1);
