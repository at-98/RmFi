...
namespace Server.Installer
{
    ...
    public class Program
    {
        ...
        private static void ShowHelpText()
        {
            ...
            ConsoleHelper.WriteLine("sudo ./RmFi_Server_Installer -b false -u lucent-sea -p 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 -s https://app.remotely.one -i /var/www/remotely/ -r latest -c true -w 0", 1);

            ConsoleHelper.WriteLine("Example (use pre-built package):");
            ConsoleHelper.WriteLine("sudo ./RmFi_Server_Installer -b true -s https://app.remotely.one -i /var/www/remotely/ -w 0");
        }
    }
}
